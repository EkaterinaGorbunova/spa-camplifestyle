...
export const Team = () => {
  return (
    <div id='team'>
      <div className='max-w-7xl mx-auto px-4 text-center sm:px-6 lg:px-8 py-14 lg:py-24'>
        <div className='space-y-8 sm:space-y-12'>
          <div className='space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl'>
            <h2 className='text-2xl md:text-4xl font-inter text-center font-extrabold text-gray-100 uppercase'>
              Meat the team
            </h2>
            <p className='text-xl text-gray-500 leading-normal text-center px-4'>
              ...
              <li key={person.name}>
                <div className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    <div className='text-xs font-inter leading-normal text-center lg:text-sm'>
